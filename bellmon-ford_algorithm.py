...
class BGraph:
    ...
    def BellmanFord(self, src):
        ...
        # Step 3: check for negative-weight cycles. The above ste guarantees shortest distances if graph doesn't contain negative weight cycle. If we get a shorter path, then there is a cycle.
